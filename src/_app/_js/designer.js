...
$(document).ready(function(){
        function mostrarMensaje() {
                ...
                function stage()
                {
                    return `<div class="container-pruebas" id="enlaces">
                    ...
                    <h3 class="navegacion">New Stage</h3>
                ...
                <div class="container1">
                    <div class="grid-item grid-item-2  active" id="form">
                        <div class="letras">
                            ...
                            <br>
                            <input class="inputs" type="text" placeholder="Cualificado"><br><br><br>
                            <label dkli-for="" class="label">Probabilidad</label>
                            ...
                            <br>
                            <input class="inputs" type="text" placeholder="100"><br><br>
                        </div>
                        ...
                        <div class="botn-delete"><hr>
                            <button class="delete" id="btn-delete" onclick="remove()">
                ...
                function remove()
                 ...
                 var eDiv=document.getElementById("enlaces");
